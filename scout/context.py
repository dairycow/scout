...
and any paragraphs added by plugins. Built once at startup, never mutated.
"""
...
def build_system(registry: Registry, skills: dict, cwd: Path,
                 plugin_prompts: list[str] | None = None) -> str:
    tools = "\n".join(
